/* ============================================================
   ...
   ============================================================ */
(function(){
  // タッチデバイス / 省データ / reduced-motion / モバイル幅では完全無効化
  var ua = navigator.userAgent;
  var isMobile = /Mobi|Android|iPhone|iPad|iPod/i.test(ua) || ('ontouchstart' in window) || window.matchMedia('(max-width: 768px)').matches;
  var saveData = !!(navigator.connection && navigator.connection.saveData);
  var reducedMotion = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
  if (isMobile || saveData || reducedMotion) {
